    ...
    <>
      ...
      >
        ...
        <div className="px-6 pt-6 pb-6 shrink-0">
          <h1 className="text-[20px] font-bold text-[#1e2b4d] leading-tight">
            SewPro Shop
          </h1>
            ...
            if (!hasSub) {
              return (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center gap-3.5 px-4 py-2.5 rounded-xl text-[14px] font-medium transition-all ${
                      isActive
                        ? "bg-[#dae5f5] text-[#1e293b] font-bold"
                ...
                >
                  <item.icon
                    size={18}
                    className={active ? "text-[#2d4a7a]" : "text-[#7a8a9e]"}
                  />
                  {item.name}
                </NavLink>
              );
            ...
            return (
              <div key={item.name} className="flex flex-col">
                <button
                  ...
                  className={`flex items-center justify-between w-full px-4 py-2.5 rounded-xl text-[14px] font-medium transition-all text-[#4a5568] hover:bg-[#e4e9f0] hover:text-[#1e293b] ${
                    active ? "text-[#1e2b4d] font-bold bg-[#e8ecf2]/55" : ""
                  }`}
                >
                ...
                {isExpanded && (
                  <div className="pl-9 pr-2 mt-1 flex flex-col gap-0.5 border-l border-slate-300/40 ml-6">
                      ...
                      return (
                        <NavLink
                          ...
                          className={`px-3 py-2 rounded-lg text-[13px] font-medium transition-all ${
                            subActive
                              ? "bg-[#dae5f5] text-[#1e293b] font-bold"
                              : "text-[#4a5568] hover:bg-[#e4e9f0]/60 hover:text-[#1e293b]"
                          }`}
                        >
                          {subItem.name}
                        </NavLink>
        ...
        <div className="p-4 mx-3 mb-4 shrink-0">
          ...
          <div className="flex items-center gap-3 px-2 py-1.5">
            ...
            <div className="flex flex-col">
              <span className="text-[13px] font-bold text-[#1e293b] leading-tight">Umar Farukh</span>
              <span className="text-[11px] text-[#64748b] font-medium leading-tight mt-0.5">Shop Owner</span>
            </div>
          </div>
        </div>
      </aside>
